...
\begin{problem}
Fix a closed (hyperbolic?) $3$-fold $M$ and a nontrivial cohomology class $\rho \in H^2(M, \RR)$.
Introduce the \dfn{canonical lamination}, which is the intersection of all maximum comass loci of a best comass form for $\rho$.
Show that the canonical lamination is a minimal lamination.
If this is not true, at least show that the intersection of calibrated loci is a minimal lamination (by an example of \cite{bangert_cui_2017} it is probably not true that the maximum comass locus is calibrated in general).
\end{problem}
...
\begin{problem}
A \dfn{stretch lamination} for $\rho$ is a maximizer $\lambda$ of $\langle \rho, [\lambda]\rangle/|\lambda|$ among measured oriented laminations.
Show that the canonical lamination is the unique $\subseteq$-maximal stretch lamination.
\end{problem}
...
Does it follow that $\lambda$ is transverse to the generic fiber of $f$?
\end{problem}
