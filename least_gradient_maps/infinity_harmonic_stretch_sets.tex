...
\begin{definition}
Let $M$ be a Riemannian manifold and $\mathscr O$ a class of precompact open subsets of $M$ with smooth boundary.
A Lipschitz map $u: M \to \RR^d$ is \dfn{absolutely minimizing Lipschitz} on $\mathscr O$ if for every $U \in \mathscr O$,
