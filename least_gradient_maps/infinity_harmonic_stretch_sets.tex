...
A Lipschitz map $u: M \to \RR^d$ is \dfn{absolutely minimizing Lipschitz} (on nonannuli) if for every precompact open set $U \subseteq M$ with smooth boundary and $H^1(U, \RR) = 0$,
