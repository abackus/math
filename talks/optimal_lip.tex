...
\item $Lu$ is upper-semicontinuous and \emph{lower-semicontinuous on average}: for any open $U$ and lower-semicontinuous $\psi$, if $Lu \leq \psi$ on almost all of $U$, then $Lu \leq \psi$ on all of $U$.
\end{itemize}
...
\begin{problem}
Which upper-semicontinuous, lower-semicontinuous on average functions can be $Lu$ for a Lipschitz map $u$?
\end{problem}
...
\begin{itemize}
\item Viscosity solutions (or, equivalently, the maximum principle) were an amazing discovery.
\begin{itemize}
