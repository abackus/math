...
\begin{frame}{Hell is contact geometry}
    \begin{itemize}
        \item The tight PDE does not characterize tight or absolutely minimizing forms. \pause 
...
\begin{itemize}
\item Key point: $\mathbb S^3$ equipped with the Hopf fibration is a contact manifold, meaning that it's hard to find integral surfaces.
\end{itemize}
\end{frame}
