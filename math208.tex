...
\end{proof}
    ...
    If $A$ is commutative, then we can find a locally compact Hausdorff space $M$ such that $A = C_\infty(M)$. We have an action $\alpha$ of $G$ on $M$ by homeomorphisms, and $G \times M$ is locally compact. The map
\begin{align*}
    G \times M &\to M\\
...
\begin{theorem}
    Let $M$ be a second-countable locally compact Hausdorff space, $A = C_\infty(M)$. Let $\sigma$ be an irreducible nondegenerate representation of $A \rtimes_\alpha G$ and let $(\pi, U)$ be the covariant representation of $\sigma$, $I = \ker \pi$. Let $Z \subseteq M$ be the hull of $I$. Then there is an $\alpha$-orbit whose closure is $Z$.
\end{theorem}
...
\begin{proof}[Proof of theorem]
    Let $\xi$ be a unit vector of the representation space $H$. Define a Radon measure $\mu$ by
