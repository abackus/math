...
(We discuss convex duality more carefully in Appendix \ref{duality derivation}.)
...
\todo{Does this prove ALL of the assertions of Theorem B?}
...
As intimiated by Proposition \ref{infty Max calibrates}, the existence (or nonexistence) of integral hypersurfaces of $\ker(\star F)$ will have a crucial role.
...
&= 4\langle F(x), \langle \nabla F(x), F(x)\rangle \otimes \theta(x)\rangle.
\end{align*}
But since $\theta$ was arbitrary, this is the dualized equation (\ref{dual infty Max}).
\end{proof}
