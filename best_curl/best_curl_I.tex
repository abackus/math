...
The \dfn{stable norm} $\Mass(\omega)$ of $\omega \in H_k(M, \RR)$ is the infimum over all currents $T$ representing $\omega$ of $\Mass(\omega)$.
Its dual norm is the \dfn{costable norm} $\Comass$ on $H^k(M, \RR)$, which is the infimum over forms of their comasses.
...
Since $\RR$ is abelian, and $H_1(M, \RR)$ is the abelianization of $\Gamma$, we can identify $\alpha$ with a class in $H^1(M, \RR)$.
...
then $\dif u$ drops to a $d - 1$-current on $M$, and its homology class is $\PD(\alpha)$.
(If $\dif u$ is actually a $1$-form, then of course its cohomology class is $\alpha$, but it turns out that the homology class will be more useful for our purposes.)
...
Let $\alpha \in \Hom(\Gamma, \RR)$ be a representation, which, as always, we identify with a class in $H^1(M, \RR)$ or equivalently as a harmonic $1$-form.
