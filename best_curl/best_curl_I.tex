...
Let $F$ be a calibration $k$-form and $T$ a $k$-calibrated current. Then:
\begin{enumerate}
...
Indeed, by Stokes' theorem, $\int_{\partial S} F = 0$, so
...
The \dfn{costable norm} $\Comass(\rho)$ of $\rho \in H^k(M, \RR)$ is the infimum over $k$-forms $F$ representing $\rho$ of the comass $\Comass(F)$.
Its dual norm, the \dfn{stable norm} $\Mass(\kappa)$ of $\kappa \in H_k(M, \RR)$, is the infimum over $k$-currents $T$ representing $\kappa$ of the mass $\Mass(T)$.
...
By the fundamental theorem of calibrated geometry, every calibrated current is homologically minimizing.
