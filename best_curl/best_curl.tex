...
On the other hand, as $p \to \infty$, the solutions of these equations converge to a minimizer of the comass; if $d = 2$, a minimizer of the comass given by a PDE is sometimes called \dfn{tight} \cite{Sheffield12, farre23}.
...
\todo{$C^2$ tight forms, what properties do they have?}
