...
Still, we are able to regularize the $q$-harmonic function $u_q$ using the heat equation and obtain the following key proposition.
...
\begin{proof}[Proof of Proposition \ref{qharmonics converge}]
