...
The total variation measure $\mu$ of $\dif u$ is a Radon measure which satisfies for every open set $U \subseteq M$ \cite[Proposition 2.5]{BackusFLG}
...
\end{equation}
We claim that $\lambda$ is \dfn{almost $F$-calibrated} in the sense that for every $\alpha$ and almost every $k$, $\sigma_{\alpha, k}$ is $F$-calibrated.
If this is not true, then there exists $\beta$ and $F \subseteq I$ such that $\mu_\beta(F) > 0$ and for every $k \in F$,
$$\int_{\sigma_{\beta, k}} \chi_\beta F < \int_{\sigma_{\beta, k}} \chi_\beta \dif S_{\beta, k}.$$
However, $\chi_\alpha$ and $\dif S_{\alpha, k}$ are nonnegative, so this contradicts (\ref{calibration condition contr}).
