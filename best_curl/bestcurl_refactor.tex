...
However, the theory of the $\infty$-Laplacian is largely built around the maximum principle and viscosity solutions, neither of which have been adequately fleshed out for systems of PDE at present.
...
In \S\ref{infinityMax} we study the PDE solved by a $C^1$ tight form.

In \S\ref{open problems} we make some concluding remarks. We discuss some external motivation and some applications for the canonical lamination and tight PDE. We also give some open problems and discuss how the results of this paper could naturally be generalized.
...
It is likely that the results largely go through for compact manifolds with boundary, as our arguments are mainly local.
...
We do not expect to be able to weaken the dimensional assumption, since the function on $\RR^8$ which is $0$ on the lower half-space, $2$ above the Simons cone, and $1$ elsewhere does not have disjoint level sets, but does have least gradient.
