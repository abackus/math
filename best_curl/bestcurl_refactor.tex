...
If $F$ is a calibration on $M$, and $F$ calibrates some hypersurface, then $F$ has best comass and the costable norm of $[F]$ is $1$ \cite[Proposition 2.2]{bangert_cui_2017}.
