...
\todo{Do we want to write down the details of this? The analogue of the line segment theorem for the stable norm, and the fact that every mass-minimizing $d - 1$-current is Ruelle-Sullivan for a geodesic lamination, would both be interesting consequences.}
