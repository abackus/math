...
%%%%%%%%%%%%%%%%%%%
\subsection{Laminations and homology}
We shall need the below facts about how laminations interact with homology, due to Auer and Bangert \cite{Auer12}.
As the cited manuscript is unpublished and unfinished, we recreate their proofs here.

Let $M$ be a closed oriented Riemannian manifold with fundamental group $\Gamma$.
...
The class $\alpha$ has \dfn{rational direction} if there exists $c > 0$ such that $c\alpha \in H_{d - 1}(M, \ZZ)$.
...
%%%%%%%%%%%%%%%%%%%%
\appendix
\section{Convex duality} \todo{Move to an appendix in the other paper maybe?}
