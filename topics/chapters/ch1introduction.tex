...
$$\int_U |\dif u| ~\vol \leq \int_U |\dif u + \dif v| ~\vol.$$
...
We would also like to know that the best-Lipschitz/least-gradient duality gives a complete proof of Theorem \ref{infinity harmonic laminations}, c.f. Corollary \ref{maximum stretch contains lamination}.
