...
We will come back to this point in \cite{BackusInfinityMaxwell1}, where we explain how in dimensions $3, 4$, one can view the $1$-Laplacian as the convex dual problem to the problem of constructing a calibration of a minimal lamination, which is given by a system of ``$\infty$-elliptic'' equations.
