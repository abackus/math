...
By (\ref{second variation formula}), it follows that $\delta^2_s |\Sigma|_h$ is continuous, where for $\Sigma, h$ fixed, the modulus of continuity only depends on $\|s\|_{W^{1, 2}}$.
