...
\begin{definition}
Let $(X, \mu)$ be a metric measure space, $E \subseteq X$ a measurable set, $x \in X$, and $\varepsilon > 0$.
The \dfn{density} of $E$ at $x$ and scale $\varepsilon$ is 
$$\Theta_E(x, \varepsilon) := \frac{\mu(E \cap B(x, \varepsilon))}{\mu(B(x, \varepsilon))}.$$
