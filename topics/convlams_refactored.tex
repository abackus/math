...
Therefore the boundary $\partial^{\rm top} E := \overline E \cap \overline{M \setminus E}$ in the sense of point-set topology is ill-defined, unless $E$ has some canonical representative of $E$.
