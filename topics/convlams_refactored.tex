...
\title{Level sets of $1$-harmonic functions II: Minimal laminations}
\author{Aidan Backus}
\date{\today}
...
We then apply this theory to prove that in constant sectional curvature, a function is $1$-harmonic iff its level sets are a minimal lamination; this resolves an open problem of Daskalopoulos--Uhlenbeck.
\end{abstract}
...
We show that any $1$-harmonic function on a manifold of constant sectional curvature gives rise to a Ruelle-Sullivan current for a minimal lamination, and conversely.
...
A sequence of laminations $(\lambda_i)$ converges to a lamination $\lambda$ in Thurston's geometric topology iff, for every leaf $N$ of $\lambda$, every $x \in N$, and every $\varepsilon > 0$, there exists $i_\varepsilon \in \NN$ such that for every $i \geq i_\varepsilon$, $\supp \lambda_i$ intersects $B(x, \varepsilon)$, and for $x_i \in B(x, \varepsilon) \cap \supp \lambda_i$,
...
%%%%%%%%%%%%%%%%%%
\subsection{Application to \texorpdfstring{$p$-harmonic}{p-harmonic} maps}\label{FLG section}
