...
\begin{proof}
	...
	Taking derivatives of both sides of (\ref{nabla as a normal}),
...
$$|F(\xi_1, \eta_1) - F(\xi_2, \eta_2)| \sim |\xi_1 - \xi_2| + |f(\xi_1, \eta_1) - f(\xi_2, \eta_2)|.$$
Moreover, by (\ref{nabla as a normal}) and (\ref{normal is almost constant}), $\|\partial_\xi f\|_{C^0} \lesssim \delta$, so if we take $\delta$ small enough then 
$$|f(\xi_1, \eta_1) - f(\xi_2, \eta_2)| \geq |f(\xi_1, \eta_1) - f(\xi_1, \eta_2)| - \|\partial_\xi f\|_{C^0} \cdot |\xi_1 - \xi_2|$$
implies 
$$|F(\xi_1, \eta_1) - F(\xi_2, \eta_2)| \gtrsim |\xi_1 - \xi_2| + |f(\xi_1, \eta_1) - f(\xi_1, \eta_2)|.$$
...
$$
so 
$$|F(\xi_1, \eta_1) - F(\xi_2, \eta_2)| \gtrsim |\xi_1 - \xi_2| + |\eta_1 - \eta_2|.$$
