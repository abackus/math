...
However, it is likely that the \emph{unmeasured} lamination \cite[Remark 2.8]{Mazon14} is uniquely determined by the Dirichlet data.
For $\overline M$ a strictly convex domain in $\RR^d$, this conjecture should follow from work of G\'orny \cite[Proposition 4.1]{górny2018}, though one needs to be careful about the formulation of the Dirichlet problem here.
In a more general (curved) setting, one would need a generalization of the extension result of the lamination to the boundary \cite[Proposition 2.13]{górny2018}.
We shall not attempt to address these issues here.
