...
Our work is closest to the proof of Colding--Minicozzi \cite[Appendix B]{ColdingMinicozziIV} for minimal laminations of a Riemannian manifold.
Their new idea is to fill in the gaps between the leaves in Solomon's constructions by linear interpolation.
However, Colding--Minicozzi take it as given that one can use the curvature bound (\ref{curvature bound in regularity}) to show that all the leaves can be represented as graphs at once.
...
This circle of ideas has been developed by the Thurston school \cite{papadopoulos:hal-00129729, Gu_ritaud_2017} but has recently also made contact with geometric PDE through the work of Daskalopoulos--Uhlenbeck \cite{daskalopoulos2020transverse,daskalopoulosPrep1,DaskalopoulosPrep2}, which we now recall.
...
\subsubsection{Ruelle-Sullivan currents}\label{RS prelims}
