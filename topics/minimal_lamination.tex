...
The gradient flow for (\ref{least gradient functional}), \dfn{level set flow}, arises in modeling of physical phenomena such as oil-water fronts, as well as a method for continuing the mean curvature flow past its singular times \cite{Evans91, Sethian90, Chen89}.
...
\todo{Move this to the other tex once you merge them}
