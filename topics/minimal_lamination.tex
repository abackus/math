...
\title{Level sets of $1$-harmonic functions I: Regularity}
\author{Aidan Backus}
\date{\today}
...
We are interested in functions of least gradient on manifolds because of their applications to geometric topology \cite{daskalopoulos2020transverse, daskalopoulosPrep1} which we recall in \S\ref{AppsSec}.
