...
% Let $Q \in \partial^* U$.
% Then there exists $\delta_* > 0$ such that for $0 < \delta < \delta_*$,
% $$\Exc_\delta(U, Q) \leq \frac{c\delta^{d - 1}}{2^d};$$
% this is a consequence of Proposition \ref{blowup theorem} and can be seen by reasoning identically to \cite[pg109]{Giusti77}.
...
% \begin{lemma}
% The decomposition of $\{u > y\}$ into minimal hypersurfaces is finite in any compact subset $K$ of $M$.
% \end{lemma}
% \begin{proof}
