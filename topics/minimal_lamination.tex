...
In any case we shall be primarily interested in the cases $d \in \{2, 3\}$ (and to a lesser extent $d = 4$) and in case $d = 2$ one can avoid the use of Corollary \ref{construction of minimal laminations} altogether using less ``fancy" methods.
The case $d = 2$, $K < 0$ is carried out explicitly in \cite[\S7.1]{daskalopoulos2020transverse}.
