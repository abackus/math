...
\end{corollary}
\begin{proof}
By \cite{Mazon14}, the first two conditions are equivalent. It is easy to see that their proof does not use the Riemannian metric in any meaningful way TODO and so applies in our setting.
