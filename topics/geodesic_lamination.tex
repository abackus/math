...
\subsection{Approximation by harmonic functions}
Our goal in this subsection is to prove the following proposition.

\begin{proposition}[bootstrapping $C^1$ minimal hypersurfaces]
\label{bootstrap C1}
...
Throughout this section we suppose that de Giorgi's lemma is false, and work towards constructing a counterexample to Proposition \ref{bootstrap C1}.
