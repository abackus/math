...
if $(g_j)$ is uniform for mollification, $\gamma_j \in (0, 1)$, $(\gamma_j) \in \ell^1$, $(t_j) \in (0, {\gamma_j}^{0.6}]$, $U_j$ has $g_j$-least perimeter, $E_j = (U_j)_{t_j}$, and
$$\int_{B_1} |d1_{E_j}| - \partial_d 1_{E_j} \leq \gamma_j.$$
