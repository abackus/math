...
%
% \begin{proposition}\label{Giusti64}
...
% Since $(U_j)$ has least perimeter with respect to $g$, $(E_j)$ hast approximately least perimeter with respect to the euclidean metric\cite[\S4-5]{Miranda66}.
%
%
%
%
...
Therefore, unless we have $\partial(T_i + T_j) = 0$ (in which case $T_i + T_j$ is a Jordan curve and we can remove both curves without changing $\partial T$),
$$\card I \leq ||T_i||$$
