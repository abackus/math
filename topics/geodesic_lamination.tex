...
We now claim that $C_c(U_i \cap U_j, (\CC^r)')$ is weakly dense in $L^\infty(U_i \cap U_j, (\CC^r)', \mu) = L^1(U_i \cap U_j, \CC^r, \mu)'.$
...
So the space of test sections $X$ separates points in $L^1(U_i \cap U_j, \CC^r, \mu)$.
